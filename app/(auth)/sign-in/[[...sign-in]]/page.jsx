...
export default function Page() {
  ...
  <a className="block text-white" href="#">
    ...
    <p className="mt-4 leading-relaxed text-white">
      A platform to help you prepare for your next job interview. We provide a
      realistic mock interview experience with AI-generated questions and
      feedback.
    </p>
  </div>
</div>
        ...
        <main className="flex items-center justify-center px-8 py-8 sm:px-12 lg:col-span-7 lg:px-16 lg:py-12 xl:col-span-6">
          <div className="max-w-xl lg:max-w-3xl">
            <div className="relative -mt-16 block lg:hidden">
             ...
             <div className="mt-4 bg-black p-6 rounded-lg">
  <h1 className="text-2xl font-bold text-white sm:text-3xl md:text-4xl">
    Welcome!
  </h1>

  <p className="mt-4 leading-relaxed text-white">
    Our goal is to help you improve your interview skills and increase your chances of landing your dream job.
  </p>
</div>
</div>
            <SignIn />
